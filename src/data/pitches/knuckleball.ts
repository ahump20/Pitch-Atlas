...
const gripModel: GripModel = {
  ...
  orientation: {
    knuckleLine: 'Knuckles bent up and forward so only the nails meet the leather.',
    palmFacing: 'Palm flat to the plate through a push release — no snap, no roll.',
  },
  provenance: claim(
    'Finger placement solved from the cited descriptions: index and middle fingernails dug in just behind a seam with the knuckles bent, thumb balancing beneath, the ball held off the palm. Schematic geometry, not an athlete scan.',
    'mlb-glossary-knuckleball',
    'reputable-analysis',
    { note: 'Some throwers brace with bent knuckles instead of nails; the no-spin push is the constant.' },
  ),
