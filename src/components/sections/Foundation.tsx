...
const { canonical } = fourSeam

const gauges: Gauge[] = [
  { key: 'spin', label: 'Spin rate', claim: canonical.physics.spinRateRpm },
  { key: 'active', label: 'Active spin', claim: canonical.physics.activeSpinPct },
  {
    key: 'ivb',
    label: 'Induced vertical break',
    claim: canonical.physics.inducedVerticalBreakIn,
    accent: true,
  },
  { key: 'axis', label: 'Spin axis', claim: canonical.physics.spinAxis },
]
    ...
    <section id="foundation" className="mx-auto max-w-6xl px-5 py-20 md:px-8 md:py-28">
      ...
      <div className="grid grid-cols-1 gap-x-10 gap-y-14 md:grid-cols-12">
        ...
        <div className="md:col-span-4">
          <GaugeRail
            gauges={gauges}
            caption="It rides less than a spinless ball. It never literally rises."
          />
        </div>
        ...
        <div className="flex flex-col gap-12 md:col-span-8">
          <div className="flex flex-col gap-6">
            ...
            <ClaimProse
              claim={canonical.grip}
              proseClassName="text-xl leading-relaxed text-ink"
            />
          ...
          <div className="flex flex-col gap-6 border-t border-machined/70 pt-12">
            <SubHeading>Carry: the gravity ghost</SubHeading>
            <ClaimProse
              claim={canonical.physics.magnus}
              proseClassName="text-xl leading-relaxed text-ink"
            />
