...
export const LOST_PITCH_ARCHIVE_IMAGES: ArchiveImage[] = [
  ...
  },
  {
    ...
    caption:
      'The doctored-ball reconstruction file gets its historical stage: crowd, venue, date. The claims stay in the sourced record.',
    source: src('commons-negro-league-all-star-1936'),
    rights: 'public-domain',
    width: 960,
    height: 720,
    qualityNote: 'Strong source at 2912 by 1639 pixels, enough for a broad contextual crop.',
    relatedSlug: 'doctored-ball-divergence-and-recovery',
    relatedLabel: 'The Doctored-Ball Divergence and the Reconstruction',
  },
  {
  ...
  },
  {
    ...
    caption: "Bell's career record gets a sourced artifact, not a fabricated mechanical profile.",
