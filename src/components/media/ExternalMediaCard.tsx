        ...
        <div className="mt-auto flex flex-wrap gap-2 pt-5">
          {embedUrl && item.availability !== 'removed' ? (
            <button
              type="button"
              onClick={popOut}
              className="rounded-sm border border-cyan/35 px-3 py-2 any-pointer-coarse:min-h-11 font-mono text-[10px] uppercase tracking-[0.11em] text-cyan transition-colors hover:border-cyan hover:text-bone"
            >
              Watch Dock ↘
            </button>
          ) : null}
          <a
            ...
            className="inline-flex items-center rounded-sm border border-bone/18 px-3 py-2 any-pointer-coarse:min-h-11 font-mono text-[10px] uppercase tracking-[0.11em] text-bone-2 transition-colors hover:border-bone/40 hover:text-bone"
          >
            Original post ↗
          </a>
        </div>
