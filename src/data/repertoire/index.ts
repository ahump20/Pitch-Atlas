...
export const REPERTOIRE: RepertoireEntry[] = [
  ...
  },
  {
    ...
    relationship: claim(
      ...
      "wiki-splitter",
      "reputable-analysis",
      { note: "Austin throws this as a fastball (pitcher's own words). The offspeed 'splitter' label is MLB's tracking taxonomy, filed separately under the Splitter specimen. Both framings stay attributed; neither overrides the other." },
    ),
    ...
    contextNote: claim(
      "Set the filed Splitter next to this and the difference is the intent: same finger spread, but Austin throws his at full fastball arm speed and files it as a fastball, where the league files the splitter as offspeed. Both classifications keep their source context.",
      "austin-grips",
      "pitcher-own-words",
    ),
  },
  ...
  },
  {
    ...
    relationship: claim(
      ...
      "wiki-splitter",
      "reputable-analysis",
      { note: "Classification note: the splitter is gripped and delivered like a fastball but is categorized as offspeed by MLB pitch tracking. MLB often uses 'split-finger fastball' as a synonym for this offspeed splitter; this atlas files Austin's split-finger fastball separately, in the fastball family, the way he threw it, with each label attributed." },
    ),
