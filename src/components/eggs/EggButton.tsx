...
export function EggButton({
  ...
  return (
    <button
      ...
      aria-label={label}
      className={`cursor-pointer rounded-sm transition-colors pointer-coarse:-mx-2 pointer-coarse:-my-[17px] pointer-coarse:px-2 pointer-coarse:py-[17px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan/70 ${
