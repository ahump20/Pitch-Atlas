...
const FORCES: Force[] = [
  ...
  },
  {
    ...
    claims: [
      claim('Satchel Paige’s hesitation pitch was ruled a balk by AL president Will Harridge in 1948, after an at-bat against Mickey Platt. The ruling legislated the pitch out of the game.', 'wiki-satchel-paige', 'reputable-analysis', { note: 'The 1948 Platt at-bat and the Harridge balk ruling.' }),
    ],
  },
  {
    era: 'Always',
    ...
    <section className="archive-section">
      ...
      <div className="mx-auto max-w-4xl px-5 py-16 md:px-8 md:py-20">
        ...
        <p className="mt-4 max-w-[68ch] text-base leading-relaxed text-ink-2">
          ...
          out of the game. The entries below are what each one left behind.
        </p>
