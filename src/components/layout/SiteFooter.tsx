    ...
    >
      ...
      <div className="mx-auto flex max-w-[1320px] flex-col gap-3 border-t border-bone/8 px-5 py-4 md:flex-row md:items-center md:justify-between md:px-8">
        ...
        <button
          type="button"
          onClick={openIndex}
          className="mono-label-stage w-fit whitespace-nowrap py-1.5 any-pointer-coarse:min-h-11 text-bone-2/75 underline decoration-bone-2/30 underline-offset-2 transition-colors hover:text-bone hover:decoration-cyan"
        >
