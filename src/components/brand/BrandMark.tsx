  ...
  return (
    <span className={`inline-flex items-center gap-3 ${className ?? ''}`}>
      ...
      >
        ...
        <ellipse cx="50" cy="50" rx="9" ry="22" fill="none" stroke="#5FE0EA" strokeWidth="1" opacity="0.45" />
        <ellipse cx="50" cy="50" rx="18" ry="22" fill="none" stroke="#5FE0EA" strokeWidth="1" opacity="0.3" />
