...
/*
  ...
  the front door, the lost-pitches wing the second. A short honesty line holds
  the floor the rest of the page rests on, then hands off to the site footer.
*/
export function CloseCta() {
  return (
    <section className="v2-stage v2-tooth relative border-t border-bone/10">
      <div className="mx-auto max-w-[760px] px-5 py-24 text-center md:px-8 md:py-32">
        ...
        <p className="mx-auto mt-8 max-w-[52ch] font-mono text-[10px] uppercase leading-relaxed tracking-[0.12em] text-bone-2/65">
          No fabricated spin, velocity, or break. No scraped imagery. No copied prose. The foil is
          decoration; the readings are not.
        </p>
      </div>
    </section>
  )
