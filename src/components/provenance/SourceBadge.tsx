...
export function SourceBadge({
  ...
  return (
    <a
      ...
      className={`mono-label min-w-0 max-w-full pointer-coarse:-my-[17px] pointer-coarse:py-[17px] underline decoration-ink-3/40 decoration-1 underline-offset-2 transition-colors hover:text-ink hover:decoration-seam ${wrapLabel ? 'inline-block text-xs leading-relaxed [overflow-wrap:anywhere]' : 'inline-flex items-baseline gap-1'} ${className}`}
