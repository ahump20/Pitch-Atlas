...
- Decorative lighting breathes at rest on slow clocks (grain, hero rim, label foil, far pools), all off under Reduced Motion. The static-at-rest pass was reversed on 2026-09-23 at the owner's request because the page read flat. Existing tilt/reveal machinery, scroll timelines, a cancellable study transition, and route view transitions supply motion. No animation dependency, data API, or schema was added.
