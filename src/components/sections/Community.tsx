    ...
    <section id="community" className="mx-auto max-w-6xl px-5 py-20 md:px-8 md:py-28">
      ...
      <div className="grid grid-cols-1 gap-x-10 gap-y-10 md:grid-cols-12">
        <div className="flex flex-col gap-5 md:col-span-4">
          <h3 className="display text-2xl leading-snug text-ink">Not open yet, on purpose.</h3>
          <p className="max-w-[42ch] leading-relaxed text-ink-2">{community.safetyNote}</p>
          <p className="max-w-[42ch] leading-relaxed text-ink-2">{community.provenanceNote}</p>
        </div>

        <div className="md:col-span-8">
          <div className="overflow-hidden rounded-sm border border-ink-3/30">
            <div className="grid grid-cols-[2.5rem_1fr_7rem_7rem] gap-3 border-b border-ink-3/30 bg-paper-2/60 px-4 py-3">
