...
README, source/confidence UI, canonical data model, source registry, grip/media rights, moderation and shared seam/contact geometry remain unchanged. Claims retain their provenance and confidence within the archive's preservation mission. The repaired white-leather rendering remains an explicitly labeled seam-informed schematic; it is not a calibrated scan.
