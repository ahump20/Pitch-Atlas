...
/*
  ...
  the specimen carries the honest accuracy disclosure.
*/
export function Hero() {
  return (
    <section
      id="top"
      className="mx-auto grid min-h-[calc(100dvh-3.5rem)] max-w-6xl grid-cols-1 items-center gap-12 px-5 pb-20 pt-12 md:grid-cols-12 md:gap-8 md:px-8"
    >
      ...
      <div className="order-2 md:order-1 md:col-span-6 lg:col-span-5">
        <h1 className="font-prose text-4xl font-bold leading-[1.04] tracking-tight text-ink md:text-5xl">
          ...
          <span className="mt-1 block font-normal text-dim">Measured, not described.</span>
        </h1>
        <p className="mt-6 max-w-[46ch] text-lg leading-relaxed text-dim">
          Pure backspin across the horseshoe. A Magnus force against the fall. This is how the pitch
          rides.
        </p>
        <a
          href="#foundation"
