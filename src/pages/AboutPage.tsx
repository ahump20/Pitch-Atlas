...
function ExternalLink({ href, children }: { href: string; children: string }) {
  return (
    <a href={href} target="_blank" rel="noreferrer" className="inline-flex items-center pointer-coarse:min-h-11 text-seam transition-colors hover:text-ink">
      {children}
    </a>
  )
}
  ...
  return (
    <>
      ...
      <SectionHero
        ...
        atmoClassName="pa-atmo-archive-paper opacity-[0.2] md:opacity-[0.28]"
      >
