      ...
      <div className="mt-5 grid grid-cols-2 gap-2.5 md:flex md:flex-wrap md:gap-3">
        {items.map((item) => (
          <Link
            key={item.to}
            to={item.to}
            className="group flex w-full items-center justify-between gap-2.5 rounded-full border border-ink/15 py-2 pointer-coarse:min-h-11 pl-3 pr-4 transition-colors hover:border-ink/40 md:inline-flex md:w-auto md:justify-start"
          >
