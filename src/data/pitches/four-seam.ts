...
const gripModel: GripModel = {
  ...
  orientation: {
    knuckleLine: 'Knuckles stacked square behind the ball, in line with the target.',
    palmFacing: 'Palm to the plate as the fingers come through the top.',
  },
  provenance: claim(
    'Finger placement solved from the cited grip descriptions: index and middle pads laid across the horseshoe seam, thumb beneath on the leather. Schematic geometry, not an athlete scan.',
    'wiki-four-seam',
    'reputable-analysis',
    { note: 'Corroborated across Wikipedia (Four-seam fastball), Wikipedia (Fastball), and eFastball.' },
  ),
